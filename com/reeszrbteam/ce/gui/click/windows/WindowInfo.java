		...
		if(isOpen())
		{
			...
			if(isExtended())
			{
				...
				for(YAWButton button: buttons)
				{
				 ...
				 //int var4 = GuiContainer.guiLeft;
			     //int var5 = GuiContainer.guiTop;
			     //Render3DPlayer(var4 + 51 + dragX, var5 + 75, 30 + dragY, (float)(var4 + 51) - this.xSize_lo + dragX, (float)(var5 + 75 - 50) - this.ySize_lo + dragY, CheatingEssentials.getMinecraftInstance().thePlayer);
			}
		}
	}
