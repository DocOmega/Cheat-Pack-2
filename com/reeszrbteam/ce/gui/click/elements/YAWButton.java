...
public class YAWButton {
	...
	public void draw() {
		...
		//	YouAlwaysWinUtils.drawGradientBorderedRect(getX() + 0.5 + window.dragX, getY() + 0.5 + window.dragY, getX() + 85.5 + window.dragX, getY() + 12 + window.dragY, 0.5F, mod.isEnabled() ? 0xFF3073D6 : 0xFF666666, mod.isEnabled() ? 0xFF4488FF : 0xFF666666, mod.isEnabled() ? 0xFF0044FF : 0xFF444444);
		//}
