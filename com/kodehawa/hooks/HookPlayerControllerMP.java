...
public class HookPlayerControllerMP  extends PlayerControllerMP
{
     ...
     */
    public static void clickBlockCreative(Minecraft par0Minecraft, HookPlayerControllerMP par1PlayerControllerMP, int par2, int par3, int par4, int par5)
    {
    ...
    public HookEntityClientPlayerMP func_78754_a(World par1World)
    {
        return new HookEntityClientPlayerMP(this.mc, par1World, this.mc.func_110432_I(), this.netClientHandler);
    }
