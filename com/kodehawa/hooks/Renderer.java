...
public class Renderer extends EntityRenderer
{
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.currentScreen != null)
            {
                ...
                catch (Throwable var12)
                {
                    ...
                    var11.addCrashSectionCallable("Screen name", new HookCallableScreenName(this));
                    var11.addCrashSectionCallable("Mouse location", new HookCallableMouseLocation(this, var16, var17));
                    var11.addCrashSectionCallable("Screen size", new HookCallableScreenSize(this, var13));
     ...
     */
    static Minecraft getRendererMinecraft(Renderer par0EntityRenderer)
    {
