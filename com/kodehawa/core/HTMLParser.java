...
public class HTMLParser {
    ...
    private static final HTMLTextExtractor ext = new HTMLTextExtractor( );
     ...
     * instead of "&#160;".
     */
    private static final String RAW_HTML_ENTITY_TABLE = "nbsp   #160 00A0   iexcl  #161 00A1   cent   #162 00A2   pound  #163 00A3   curren #164 00A4   yen    #165 00A5 "
     ...
     * @return
     */
    public static String getStringFromRemoteServer( String lru ) {
        StringBuilder html = new StringBuilder( );
        try {
            java.net.URL url = new URL( lru );
        	...
        	System.out.printf( "CUpdater", "An error occurred while checking for an update!" );
